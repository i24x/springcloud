package com.github.i24x.springcloud.service.dao.test;
...
import com.github.i24x.springcloud.service.application.StartupApplication_A1;
import com.github.i24x.springcloud.service.model.User;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringBootTest(classes = StartupApplication_A1.class)
...
//	@Test
	public void customer(){
		ServiceInstance serviceInstance = loadBalancerClient.choose("service-B");
...
//	@Test
	public void customerRibbon(){
		String url = "http://service-B"+"/UserController/getDefaultUser";
        String r = restTemplate.getForObject(url, String.class);
        logger.info(r);
	}
}