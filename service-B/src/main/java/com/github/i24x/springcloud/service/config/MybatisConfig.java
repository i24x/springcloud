...
public class MybatisConfig implements EnvironmentAware {
    ...
    private static String regexp = "execution (* com.github.i24x.springcloud.service..*Impl.*(..))";
...
//        sqlSessionFactoryBean.setConfigLocation(resolver.getResources("classpath:mybatis-config.xml")[0]);
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage(propertyResolver.getProperty("mapper.package"));//注意路径配置
